    ...
    <div className="w-full" style={{ background: '#090d12' }}>
      ...
      <div className="px-4 md:px-10 py-10" style={{ background: '#090d12' }}>
        <div className="max-w-[680px] mx-auto text-center">
          ...
          <p className="text-base md:text-lg leading-relaxed mb-6" style={{ background: 'linear-gradient(135deg, #a78bfa, #7c3aed)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>180 people. One wallet. One villa. Every euro visible on-chain. No fund manager. No bank. No bullshit.</p>
